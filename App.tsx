    ...
    <div className="min-h-screen font-sans selection:bg-brand-teal selection:text-white mesh-bg overflow-x-hidden text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mb-10 leading-relaxed font-light max-w-lg mx-auto lg:mx-0">
              The first voice-native desktop AI agent workspace. Connect Gemini, Claude, or local LLMs to your files and apps using the Model Context Protocol (MCP) for seamless workflow automation.
            </p>
      ...
      <section id="features" className="py-24 bg-brand-surface/50 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">The Universal AI Agent for Your Tools</h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              We use the open standard <strong className="text-white">Model Context Protocol (MCP)</strong>. This means your workflow automation AI agent doesn't just chat—it securely plugs into your tools, whether they are in the cloud or on your hard drive, handling general work flow automation easily.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <FeatureCard
              ...
              description="Forget typing prompts. Speak naturally to your AI agent. We use VAD (Voice Activity Detection) to know when you pause and when you stop, allowing for frictionless workflow automation."
              icon={<Mic size={32} />}
              delay={0.3}
            >
      ...
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-white">Ready to automate your general workflows?</h2>
          <p className="text-gray-400 mb-12">Join 10,000+ users leveraging our AI agent in the beta.</p>
