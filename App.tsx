      ...
      <AnimatePresence mode="wait">
                ...
                >
                  ...
                  >
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-surface-elevated rounded-md text-xs font-mono text-gray-300 border border-surface-border">Google Drive</span>
                      <span className="px-3 py-1 bg-surface-elevated rounded-md text-xs font-mono text-gray-300 border border-surface-border">Slack</span>
                      <span className="px-3 py-1 bg-surface-elevated rounded-md text-xs font-mono text-gray-300 border border-surface-border">Your Software</span>
                    </div>
                  </FeatureCard>
            ...
            <section id="download" aria-labelledby="download-heading" className="py-24 px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <motion.div
                  ...
                  className="bg-surface-card rounded-3xl border border-surface-border p-1 pt-0 overflow-hidden relative shadow-2xl"
                >
                  {/* Top Gradient Line */}
                  <div className="h-1 w-full bg-gradient-to-r from-brand-teal to-brand-primary"></div>
                  ...
                  <div className="p-8 md:p-12">
                    ...
                    <motion.a
                      ...
                      className="w-full md:w-auto inline-block text-center px-12 py-4 bg-white text-brand-dark font-bold rounded-xl transition-colors hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-surface-card text-lg shadow-xl shadow-black/10">
                      Join Waiting List
                    </motion.a>
        ...
        {page === 'products' && (
          <motion.div
            ...
            className="w-full"
          >
            <ProductsPage onBack={() => navigate('home')} />
          </motion.div>
        )}
        {page === 'download' && (
          <motion.div
